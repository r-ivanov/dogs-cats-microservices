...
public class DogController {
  ...
  @Operation(
    ...
    description = "Uploads a photo for an existing dog and updates its photoUrl"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
  ...
  public ResponseEntity<DogResponse> uploadPhoto(
      @PathVariable Long id,
      @RequestParam("file") MultipartFile file) {

    DogResponse response = service.uploadPhoto(id, file);
